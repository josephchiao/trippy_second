...
class DoublePendulum:
    ...
    def __init__(self, params = (9.81, 1, 1, 1, 1, 1), y0 = [0, 0, 0, 0, 0, 0], t_start = 0.0, t_end = 20, refresh_rate = 60, max_motor_force = 100, target = 0):
        ...
        self.t_eval = np.linspace(t_start, t_end, int((t_end - t_start) * refresh_rate))
